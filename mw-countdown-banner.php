...
add_action('init', 'mwcb_enqueue_admin_scripts');

add_action('after_setup_theme', 'mw_countdow_banner_setup');
function mw_countdow_banner_setup()
{
    load_plugin_textdomain('mw-countdown-banner', false, dirname(plugin_basename(__FILE__)) . '/languages');
}
